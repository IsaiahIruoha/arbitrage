...
const KrakenAPI = () => {
  ...
  const postCombinedData = async () => {
    ...
    try{
      ...
      const response = await axios.post('https://arb-backend-7eead36ec15a.herokuapp.com/process-graph', postData, {
        headers: {
  ...
  return (
    <div className='page'>
      ...
      <b>Note 1: </b>The above graph data is pulled in real time from the Kraken API. Paths are generated in the backend by the model, using
        this graph instance as input. <br></br><br></br><b>Note 2:</b> The model response and path-showing animation has been significantly slowed down to allow 
